...
This guide will demonstrate how to imgs

### LAMMPS Usage Process

#### Workflow

![lammps_workflow](./imgs/lammps_workflow.png)
...
![easybuild_easyconfig](./imgs/easybuild_easyconfig.png)
...
![easybuild_easybuild_file](./imgs/easybuild_easybuild_file.png)
...
![buildlammps](./imgs/buildlammps.png)
...
![add_lammps_cpu](./imgs/add_lammps_cpu.png)
...
![lammps_runtime](./imgs/lammps_runtime.png)

Create LAMMPS GPU Runtime : **LAMMPS_GPU_ENV**

![add_lammps_gpu](./imgs/add_lammps_gpu.png)
...
![lammps_gpu_runtime](./imgs/lammps_gpu_runtime.png)

Create VMD  CPU Runtime : **VMD_CPU_ENV**

![add_VMD_cpu](./imgs/add_VMD_cpu.png)
...
![vmd_cpu_runtime](./imgs/vmd_cpu_runtime.png)

Create VMD  GPU Runtime : **VMD_GPU_ENV**

![add_VMD_gpu](./imgs/add_VMD_gpu.png)
...
![vmd_gpu_runtime](./imgs/vmd_gpu_runtime.png)
...
![lammps_job](./imgs/lammps_job.png)
...
![lammps_gpu_job](./imgs/lammps_gpu_job.png)
...
![lammps_job_log](./imgs/lammps_job_log.png)
...
![lammps_result_dir](./imgs/lammps_result_dir.png)
...
![VMD_settings](./imgs/VMD_settings.png)
...
![vmd_open_result](./imgs/vmd_open_result.png)
...
1. Failure to download dependencies during EasyBuild software compilation due to the inability to connect to the external network:
   ...
   ![easybuild_error01_log](./imgs/easybuild_error01_log.png)
